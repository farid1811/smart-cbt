...
class QuestionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'question_image'    => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:10240',
            'option_a_image'    => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:10240',
            'option_b_image'    => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:10240',
            'option_c_image'    => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:10240',
            'option_d_image'    => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:10240',
            'opsi_e'            => 'nullable|string',
            'option_e_image'    => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:10240',
            ...
            'explanation_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:10240',
