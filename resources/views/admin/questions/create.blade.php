...
<div class="form-card" style="max-width:880px; margin: 0 auto; background:#fff; padding:2rem; border-radius:12px; box-shadow:0 4px 6px -1px rgba(0,0,0,0.05);">
    ...
    <form method="POST" action="{{ route('admin.questions.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group" style="margin-bottom:1.25rem;">
            ...
            <textarea name="soal" class="form-control" rows="3" placeholder="Tuliskan soal di sini (mendukung formula LaTeX/KaTeX seperti $x^2 + y^2 = z^2$ atau $$ \int x dx $$)..." required style="width:100%; padding:0.625rem; border-radius:6px; border:1px solid #cbd5e1; font-family:inherit;">{{ old('soal') }}</textarea>
