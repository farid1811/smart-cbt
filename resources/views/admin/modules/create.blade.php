...
<div style="max-width:640px; margin:0 auto;">
    <div class="table-card" style="padding:0; background:#fff; border-radius:12px; box-shadow:0 4px 6px -1px rgba(0,0,0,0.05);">
        <div class="table-header" style="padding:1.25rem 1.5rem; border-bottom:1px solid #e2e8f0;">
            <div>
                <h3 style="font-weight:800; font-size:1.15rem; color:#0f172a; margin:0 0 0.25rem;">Tambah Modul Baru</h3>
                <p style="font-size:0.8rem; color:#64748b; margin:0;">Lengkapi formulir di bawah untuk menambahkan materi belajar baru berdasarkan kategori hierarki.</p>
            </div>
        </div>

        <form method="POST" action="{{ route('admin.modules.store') }}" enctype="multipart/form-data" style="padding:1.5rem;">
            @csrf
            ...
            <div class="form-group" style="margin-bottom:1.25rem;">
                ...
                <input type="text" id="name" name="name" class="form-control" value="{{ old('name') }}" placeholder="Masukkan nama modul pembelajaran" required style="width:100%; padding:0.625rem; border-radius:6px; border:1px solid #cbd5e1;">
            ...
            <div class="form-group" style="margin-bottom:1.25rem;">
                ...
                <textarea id="description" name="description" class="form-control" placeholder="Deskripsi ringkas materi modul..." rows="3" style="width:100%; padding:0.625rem; border-radius:6px; border:1px solid #cbd5e1; font-family:inherit;">{{ old('description') }}</textarea>
            ...
            <div class="form-group" style="margin-bottom:1.5rem;">
                ...
                <input type="url" id="video_url" name="video_url" class="form-control" value="{{ old('video_url') }}" placeholder="https://youtube.com/watch?v=..." style="width:100%; padding:0.625rem; border-radius:6px; border:1px solid #cbd5e1;">
            ...
            <div class="form-group" style="margin-bottom:1.5rem;">
                ...
                <div style="display:flex; gap:1.25rem; margin-top:0.35rem;">
                    <label style="display:flex; align-items:center; gap:0.5rem; cursor:pointer; font-size:0.9rem;">
                        <input type="radio" name="is_active" value="1" {{ old('is_active', '1') === '1' ? 'checked' : '' }} style="accent-color:#1e40af;">
                        <span style="color:#16a34a; font-weight:700;">Aktif</span>
                    </label>
                    <label style="display:flex; align-items:center; gap:0.5rem; cursor:pointer; font-size:0.9rem;">
                        <input type="radio" name="is_active" value="0" {{ old('is_active') === '0' ? 'checked' : '' }} style="accent-color:#ef4444;">
